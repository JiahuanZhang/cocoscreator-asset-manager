...
let AssetFind = {
    ...
    // 通过uuid查找
    start_find(sourceFile, destFile, uuid) {
    ...
    getUUIDFromMeta(metaPath, sourceName) {
        ...
        if (!!meta && !!meta.subMetas) {
            ...
            console.error("Get uuid from meta failed!");
        }
        return uuid;
    },
    ...
    getRawUUIDFromMeta(metaPath) {
        ...
        if (!!meta && !!meta.uuid) {
            ...
            console.error("Get raw uuid from meta failed!");
        }
        return uuid;
    },
    ...
    getPlistUUIDFromMeta(metaPath) {
        ...
        if (!!meta && !!meta.uuid) {
            ...
            console.error("Get PlistUUID from meta failed!");
        }
        if (!!meta && !!meta.subMetas) {
